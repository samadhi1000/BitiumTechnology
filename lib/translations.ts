...
export const translations: Record<Language, Translations> = {
  ...
  si: {
    nav: {
      ...
      howItWorks: "ක්රියාත්මක වන ආකාරය",
      portfolio: "අපගේ නිමවුම්",
      about: "අප පිළිබඳව",
      contact: "අප හා සම්බන්ධ වන්න",
      stencil: "ස්ටෙන්සිල් (Stencil)",
      batikStamp: "බතික් මුද්රා (Batik Stamp)",
      downloads: "බාගත කිරීම් (Downloads)",
      materials: "ද්රව්ය හා අමුද්රව්ය",
      toolkit: "මෙවලම් කට්ටලය"
    },
    subNav: {
      dtfPrinting: "DTF මුද්රණය",
      screenPrinting: "ස්ක්රීන් මුද්රණය",
      ...
      sizeGuide: "ප්රමාණ මඟපෙන්වීම (Size Guide)"
    },
    hero: {
      badge: "වෘත්තීය මට්ටමේ මුද්රණ සහ ලේසර් තාක්ෂණය",
      titlePrefix: "උසස් තත්වයේ ",
      titleHighlight: "DTF සහ මුද්රණ",
      titleSuffix: " සේවාවන්, දැන් ඉතා පහසුවෙන්.",
      description: "ඔබේ නිර්මාණය අප වෙත ලබාදී, 3D තාක්ෂණයෙන් පෙරදසුනක් පරීක්ෂා කර, මිනිත්තු කිහිපයක් ඇතුළත උසස් තත්වයේ මුද්රණ සහ ලේසර් කැපුම් සේවා සඳහා ඇණවුම් කරන්න.",
      btnCreate: "ඔබේ නිර්මාණය අරඹන්න",
      btnBrowse: "අපගේ සේවාවන්",
      stats: {
        accuracyTitle: "99%ක මුද්රණ නිරවද්යතාව",
