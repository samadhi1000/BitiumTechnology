          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
            ...
            <div className="relative w-full md:w-72">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-card border border-border text-xs text-foreground placeholder-zinc-500 focus:outline-none focus:border-amber-500 transition-colors"
              />
            </div>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-20 bg-card/30 rounded-3xl border border-border">
            ...
            <button
              ...
              className="mt-4 px-4 py-2 rounded-xl bg-amber-600 text-xs font-bold text-foreground hover:bg-amber-500 transition-all"
            >
              Reset Search
            </button>
          </div>
          ...
          <>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div
                key={product.id}
                className="group relative rounded-2xl border border-border bg-card/40 hover:border-amber-500/40 hover:bg-card/80 transition-all duration-300 flex flex-col h-full overflow-hidden shadow-sm hover:shadow-xl"
              >
                {/* Product Image */}
                <div className="relative w-full aspect-square bg-background overflow-hidden">
                  ...
                  <div className="absolute top-4 right-4 px-2.5 py-1 rounded-md bg-card/80 backdrop-blur-md border border-border text-[10px] font-extrabold text-amber-300 uppercase tracking-wider">
                    Cap Batik
                  </div>
                </div>
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <div className="mt-6 flex items-center justify-between border-t border-border pt-4">
                    ...
                    <Link
                      ...
                      className="px-4 py-2.5 rounded-xl bg-amber-600 hover:bg-amber-500 text-foreground font-bold text-xs transition-all shadow-md hover:shadow-amber-600/20"
                    >
                      View Stamp
                    </Link>
                  </div>
      ...
      <section className="border-t border-border bg-background py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-black text-foreground">Copper vs. wood stamps</h2>
