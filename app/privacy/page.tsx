      ...
      <div className="max-w-4xl mx-auto relative z-10 space-y-10">
        ...
        <div className="text-center space-y-4">
          <div className="inline-flex items-center gap-2 bg-[#8DFF00]/10 border border-[#8DFF00]/25 rounded-full px-3.5 py-1.5 mb-2">
            <Shield size={12} className="text-[#8DFF00]" />
            <span className="font-heading font-semibold text-[11px] text-[#8DFF00] tracking-wider uppercase">SECURITY & TRUST</span>
          </div>
          <h1 className="text-4xl sm:text-5xl font-black tracking-tight text-foreground">
            Privacy <span className="text-[#8DFF00]">Policy</span>
          </h1>
        ...
        <div className="p-8 sm:p-12 rounded-3xl border border-border bg-card/40 backdrop-blur space-y-8 text-sm text-muted-foreground leading-relaxed">
          <p>
            Bitium Technology (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) operates the website <a href="https://www.bitiumtechnology.com" className="text-[#8DFF00] hover:underline">bitiumtechnology.com</a>, offering DTF (Direct-to-Film) and screen printing services in Sri Lanka. This policy explains what information we collect from you, how we use it, and the choices you have.
          </p>
          <p>
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-[#8DFF00] font-heading">Information We Collect</h2>
            ...
            <div className="space-y-3">
              ...
              <p>
                When you browse the site, we use Google Analytics to understand how visitors use it - pages viewed, time on site, general location, and device/browser type. This data is aggregated and doesn&apos;t identify you personally. You can opt out of Google Analytics tracking using the <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noopener noreferrer" className="text-[#8DFF00] hover:underline">Google Analytics Opt-out Browser Add-on</a>.
              </p>
              <p>
          ...
          {/* Section 2 */}
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-[#8DFF00] font-heading">How We Use Your Information</h2>
          ...
          {/* Section 3 */}
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-[#8DFF00] font-heading">Payments</h2>
            <p>
          ...
          {/* Section 4 */}
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-[#8DFF00] font-heading">Sharing Your Information</h2>
          ...
          {/* Section 5 */}
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-[#8DFF00] font-heading">Data Retention</h2>
            <p>
          ...
          {/* Section 6 */}
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-[#8DFF00] font-heading">Your Rights</h2>
            ...
            <p>
              To exercise any of these rights, contact us at <a href="mailto:indrajith105@gmail.com" className="text-[#8DFF00] hover:underline">indrajith105@gmail.com</a>.
            </p>
          </div>
          ...
          {/* Section 7 */}
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-[#8DFF00] font-heading">Data Security</h2>
            <p>
          ...
          {/* Section 8 */}
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-[#8DFF00] font-heading">Children&apos;s Privacy</h2>
          ...
          {/* Section 9 */}
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-[#8DFF00] font-heading">Changes to This Policy</h2>
            <p>
