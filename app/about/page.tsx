...
export default function AboutPage() {
  ...
  return (
    <div className="w-full min-h-screen bg-background text-foreground py-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#2CFF05]/10 rounded-full filter blur-[140px] pointer-events-none" />

      <div className="max-w-6xl mx-auto relative z-10 space-y-24">
        
        {/* ── 1. HERO SECTION ── */}
        <div className="text-center space-y-6 max-w-3xl mx-auto pt-4">
          <div className="inline-flex items-center gap-2 bg-[#2CFF05]/10 border border-[#2CFF05]/30 rounded-full px-4 py-1.5 shadow-sm">
            <Sparkles size={14} className="text-[#2CFF05] animate-pulse" />
            <span className="font-heading font-bold text-[11px] text-[#2CFF05] tracking-widest uppercase">
        ...
        <div className="relative rounded-3xl p-8 sm:p-12 bg-gradient-to-b from-card/90 via-card/60 to-card/40 border border-border/80 hover:border-[#2CFF05]/40 transition-all duration-300 shadow-2xl backdrop-blur-md overflow-hidden">
          <div className="absolute top-0 right-0 w-80 h-80 bg-[#2CFF05]/10 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <h2 className="text-3xl sm:text-4xl font-black text-foreground font-heading leading-tight">
                {isSinhala ? (
                  <>අපගේ ගමන් මග: <span className="text-[#2CFF05]">2014 සිට</span> ගොඩනැගුණු විශ්වාසය</>
                ) : (
                  <>Our Journey: <span className="text-[#2CFF05]">Built on Trust</span> Since 2014</>
                )}
              </h2>
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2">
                <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg bg-background/70 border border-border text-xs font-semibold text-foreground">
                  <CheckCircle2 size={13} className="text-[#2CFF05]" />
            ...
            <div className="lg:col-span-5 grid grid-cols-2 gap-4">
              <div className="p-6 rounded-2xl bg-background/80 border border-border/80 hover:border-[#2CFF05]/40 transition-colors shadow-lg">
                <div className="text-3xl sm:text-4xl font-black text-[#2CFF05] font-heading">2014</div>
              ...
              <div className="p-6 rounded-2xl bg-background/80 border border-border/80 hover:border-[#2CFF05]/40 transition-colors shadow-lg">
                <div className="text-3xl sm:text-4xl font-black text-[#2CFF05] font-heading">12+</div>
                <div className="text-xs font-bold text-foreground mt-1">
              ...
              <div className="p-6 rounded-2xl bg-background/80 border border-border/80 hover:border-[#2CFF05]/40 transition-colors shadow-lg">
                <div className="text-3xl sm:text-4xl font-black text-[#2CFF05] font-heading">10+</div>
                <div className="text-xs font-bold text-foreground mt-1">
              ...
              <div className="p-6 rounded-2xl bg-background/80 border border-border/80 hover:border-[#2CFF05]/40 transition-colors shadow-lg">
                <div className="text-3xl sm:text-4xl font-black text-[#2CFF05] font-heading">100%</div>
                <div className="text-xs font-bold text-foreground mt-1">
        ...
        <div className="space-y-10">
          <div className="text-center space-y-3 max-w-2xl mx-auto">
            <div className="inline-flex items-center gap-2 text-xs font-bold text-[#2CFF05] tracking-widest uppercase font-heading">
              <Layers size={14} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-8 rounded-3xl bg-card/40 hover:bg-card/70 border border-border/80 hover:border-[#2CFF05]/50 transition-all duration-300 space-y-4 shadow-xl group relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#2CFF05]/5 rounded-full blur-2xl group-hover:bg-[#2CFF05]/15 transition-all pointer-events-none" />
              
              <div className="flex items-center justify-between">
                <div className="w-14 h-14 rounded-2xl bg-[#2CFF05]/10 border border-[#2CFF05]/30 flex items-center justify-center text-[#2CFF05] group-hover:scale-110 transition-transform">
                  <Palette size={26} />
                </div>
              ...
              <h3 className="text-xl font-black text-foreground font-heading group-hover:text-[#2CFF05] transition-colors">
        ...
        <div className="space-y-10">
          <div className="text-center space-y-3 max-w-2xl mx-auto">
            ...
            <h2 className="text-3xl sm:text-4xl font-black text-foreground font-heading">
              {isSinhala ? (
                <>ඇයි <span className="text-[#2CFF05]">බිටියම් ටෙක්නොලොජි?</span></>
              ) : (
                <>Why <span className="text-[#2CFF05]">Bitium Technology?</span></>
              )}
            </h2>
            <p className="text-sm sm:text-base text-muted-foreground">
              {isSinhala
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="p-8 rounded-3xl bg-card/30 hover:bg-card/60 border border-border/80 hover:border-[#2CFF05]/40 transition-all duration-300 space-y-5 shadow-lg group flex flex-col justify-between">
              <div className="space-y-4">
                <div className="w-14 h-14 rounded-2xl bg-[#2CFF05]/10 border border-[#2CFF05]/30 flex items-center justify-center text-[#2CFF05] group-hover:scale-105 transition-transform">
                  <ThumbsUp size={26} />
                </div>
                
                <div className="space-y-1">
                  <div className="text-2xl sm:text-3xl font-black text-[#2CFF05] font-heading">
                    99%
                  </div>
              ...
              <div className="pt-4 border-t border-border/60">
                <span className="text-[11px] font-semibold text-[#2CFF05] flex items-center gap-1.5">
        ...
        <div className="relative rounded-3xl p-8 sm:p-12 bg-gradient-to-r from-card/90 via-card/70 to-card/90 border-2 border-[#2CFF05]/30 shadow-2xl overflow-hidden">
          <div className="absolute top-0 right-0 w-96 h-96 bg-[#2CFF05]/10 rounded-full blur-3xl pointer-events-none" />
          <div className="absolute bottom-0 left-0 w-80 h-80 bg-[#2CFF05]/10 rounded-full blur-3xl pointer-events-none" />
          
          <div className="relative z-10 max-w-4xl mx-auto space-y-8 text-center sm:text-left">
            
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="inline-flex items-center gap-2 bg-[#2CFF05]/15 border border-[#2CFF05]/40 rounded-full px-4 py-1.5">
                <TrendingUp size={15} className="text-[#2CFF05]" />
                <span className="font-heading font-bold text-xs text-[#2CFF05] tracking-wider uppercase">
            ...
            <div className="space-y-4">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-foreground font-heading leading-tight">
                {isSinhala ? (
                  <>ශ්‍රී ලංකාව පුරා <span className="text-[#2CFF05]">ව්‍යාපාර සවිබල ගැන්වීම</span></>
                ) : (
                  <>Empowering Businesses <span className="text-[#2CFF05]">Across Sri Lanka</span></>
                )}
              </h2>

              <div className="p-6 sm:p-8 rounded-2xl bg-background/80 border border-border/80 shadow-inner relative">
                <Quote size={28} className="text-[#2CFF05]/20 absolute top-4 right-4 pointer-events-none" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
              <div className="p-4 rounded-2xl bg-card/60 border border-border/80 flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-[#2CFF05]/10 text-[#2CFF05] flex items-center justify-center shrink-0">
                  <Video size={18} />
                </div>
                <div>
        ...
        {/* ── 7. CALL TO ACTION ── */}
        <div className="p-8 sm:p-12 rounded-3xl bg-gradient-to-r from-card/60 via-card/40 to-card/60 border border-[#2CFF05]/30 text-center space-y-6 max-w-3xl mx-auto shadow-2xl relative overflow-hidden">
          ...
          <div className="flex gap-4 justify-center flex-wrap pt-2 relative z-10">
            <Link 
              href="/canvas" 
              className="px-7 py-3.5 rounded-full bg-[#2CFF05] hover:bg-[#45ff24] text-xs font-black shadow-lg shadow-[#2CFF05]/20 text-[#0a0a0a] transition-all flex items-center gap-2 group"
            >
            ...
            <Link 
              href="/contact" 
              className="px-7 py-3.5 rounded-full border border-border bg-background/60 hover:bg-card text-xs font-bold text-foreground transition-all flex items-center gap-2"
            >
